                    ...
                    <div className="sticky top-8 bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="pt-4 border-t border-slate-700 flex gap-2">
                                <button className="flex-1 py-2 px-3 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700 transition">
                                    💬 Message
                                </button>
                                <button className="flex-1 py-2 px-3 rounded-lg border border-slate-600 text-gray-300 text-sm hover:bg-slate-700 transition">
                                    ⭐ Save
                                </button>
                            </div>
                        </div>
